	...
	<div class="card-body">
		<form action="" id="mechanic-form">
            ...
            <div class="form-group">
                ...
                <input name="contact" id="contact" type="tel" class="form-control rounded-0" pattern="[0-9]{10}" placeholder="987654321" value="<?php echo isset($contact) ? $contact : ''; ?>" required>
			</div>
            <div class="form-group">
				<label for="email" class="control-label">Email</label>
                <input name="email" id="email" type="email" class="form-control rounded-0"  pattern=".+@gmail\.com" placeholder="xyz@gmail.com"  value="<?php echo isset($email) ? $email : ''; ?>" required>
			</div>
            <div class="form-group">
