	...
	<div class="card-body">
		<form action="" id="service-form">
			...
			<div class="form-group">
                ...
                <textarea name="service" id="" cols="30" rows="1" class="form-control "><?php echo isset($service) ? $service : ''; ?></textarea>
			</div>
			<div class="form-group">
				<label for="description" class="control-label">Description</label>
                <textarea name="description" id="" cols="30" rows="2" class="form-control form no-resize "><?php echo isset($description) ? html_entity_decode(stripslashes($description)) : ''; ?></textarea>
			</div>
            <div class="form-group">
